...
public class SalespersonWithFurthestBelowTargetSelector {
    ...
    public Salesperson selectSalesPersonWithFurthestBelowTarget(List<Salesperson> sales) {
        ...
        for (Salesperson salesperson : sales) {
            if (salespersonWithFurthestBelowTarget == null || salesperson.getDifferenceFromTarget() < 0 && salesperson.getDifferenceFromTarget() < salespersonWithFurthestBelowTarget.getDifferenceFromTarget()) {
